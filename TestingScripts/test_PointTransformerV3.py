...
def parse_args():
    ...
    parser.add_argument("--offset_model", type=str, default="TreeLearn_U3_V0.02_N0.1_O_FNH_CV", help="Name of the model for offset prediction")
    parser.add_argument("--noise_model", type=str, default="TreeLearn_U3_V0.02_N0.05_N_FNH_CV", help="Name of the model for noise classification")
